 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `CHModel` protocol for custom methods.
 
 
 Sample Code:
    
     ********************** json convertor *********************
     @interface CHAuthor : NSObject
     @property (nonatomic, strong) NSString *name;
     @property (nonatomic, assign) NSDate *birthday;
     @end
     @implementation CHAuthor
     @end
 
     @interface CHBook : NSObject
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) NSUInteger pages;
     @property (nonatomic, strong) CHAuthor *author;
     @end
     @implementation CHBook
     @end
    
     int main() {
         // create model from json
         CHBook *book = [CHBook CH_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
         // convert model to json
         NSString *json = [book CH_modelToJSONString];
         // {"author":{"name":"J.K.Rowling","birthday":"1965-07-31T00:00:00+0000"},"name":"Harry Potter","pages":256}
     }
 
     ********************** Coding/Copying/hash/equal *********************
     @interface CHShadow :NSObject <NSCoding, NSCopying>
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) CGSize size;
     @end
 
     @implementation CHShadow
     - (void)encodeWithCoder:(NSCoder *)aCoder { [self CH_modelEncodeWithCoder:aCoder]; }
     - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self CH_modelInitWithCoder:aDecoder]; }
     - (id)copyWithZone:(NSZone *)zone { return [self CH_modelCopy]; }
     - (NSUInteger)hash { return [self CH_modelHash]; }
     - (BOOL)isEqual:(id)object { return [self CH_modelIsEqual:object]; }
     @end
 
 */
@interface NSObject (CHModel)
 ...
 */
+ (nullable instancetype)CH_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> NSDate, parsed with format "CHCH-MM-dd'T'HH:mm:ssZ", "CHCH-MM-dd HH:mm:ss" or "CHCH-MM-dd".
     `NSString` -> NSURL.
 ...
 */
- (nullable id)CH_modelToJSONObject;
 ...
 */
- (nullable NSData *)CH_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)CH_modelToJSONString;
 ...
 */
+ (nullable NSArray *)CH_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (CHModel)
...
/**
 ...
 @return A array, or nil if an error occurs.
 */
+ (nullable NSDictionary *)CH_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<CHModel>' to your class header.
 */
@protocol CHModel <NSObject>
@optional
...
/**
 ...
 object will be add to the array/set/dictionary.
  ...
  Example:
        @class CHShadow, CHBorder, CHAttachment;
 
        @interface CHAttributes
        @property NSString *name;
        ...
        @implementation CHAttributes
        + (NSDictionary *)modelContainerPropertyGenericClass {
            return @{@"shadows" : [CHShadow class],
                     @"borders" : CHBorder.class,
...
/**
 ...
 Example:
        @class CHCircle, CHRectangle, CHLine;
 
        @implementation CHShape

        + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [CHCircle class];
            } else if (dictionary[@"width"] != nil) {
                return [CHRectangle class];
